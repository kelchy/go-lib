...
// TODO: Some of these are missing implementation for options
	...
	*/
	...
	if result != nil {
		for _, id := range result.InsertedIDs {
			insertObjID, ok := id.(bson.ObjectID)
...
func (client Client) InsertOne(ctx context.Context, colname string, doc interface{}) (interface{}, error) {
	...
	insertObjID, ok := result.InsertedID.(bson.ObjectID)
	// if _id is generated by mongo
	if ok {
...
func (client Client) UpdateOne(ctx context.Context, colname string,
	filter interface{}, update interface{}, opts ...options.Lister[options.UpdateOneOptions]) (int64, error) {
	// select collection
	col := client.Db.Collection(colname)
...
func (client Client) DeleteMany(ctx context.Context, colname string, filter interface{}) (int64, error) {
	...
	// delete
	result, e := col.DeleteMany(ctx, filter, nil)
	if e != nil {
...
func (client Client) DeleteOne(ctx context.Context, colname string, filter interface{}) (int64, error) {
	...
	// delete
	result, e := col.DeleteOne(ctx, filter, nil)
	if e != nil {
...
func (client Client) ReplaceOne(ctx context.Context, colname string,
	filter interface{}, replace interface{}, opts ...options.Lister[options.ReplaceOptions]) (int64, error) {
	// select collection
	col := client.Db.Collection(colname)
